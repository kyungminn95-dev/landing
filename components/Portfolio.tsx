...
const ITEMS: Record<TabKey, Item[]> = {
  "Brand": [
    ...
    { type: "youtube", id: "a8U0Q25IiHQ",  title: "웹드라마 '백설공주와 수상한 여행사' OST", label: "BGM",  tags: ["BGM", "작편곡"] },
  ...
  "Artist": [
    ...
    { type: "youtube", id: "a8U0Q25IiHQ", title: "웹드라마 '백설공주와 수상한 여행사' OST", label: "작편곡", tags: ["작편곡", "BGM"] },
